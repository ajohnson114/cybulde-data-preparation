...
def config_args_parser() -> argparse.Namespace:
    ...
    parser.add_argument("--overrides", nargs="*", required=True, help="hydra config overrides", default=[])
    return parser.parse_args()

def compose_config(config_path: str, config_name: str, overrides: Optional[list[str]]=None):
    setup_config()
    setup_logger()
