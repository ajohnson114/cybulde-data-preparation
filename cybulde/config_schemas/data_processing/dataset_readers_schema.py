...
@dataclass
class JigsawToxicCommentDatasetReaderConfig(DatasetReaderConfig):
    _target_: str = "cybulde.data_processing.dataset_readers.JigsawToxicCommentDatasetReader"
    dev_split_ratio: float = MISSING
...
def setup_config() -> None:
    ...
    cs.store(
        ...
        node=JigsawToxicCommentDatasetReaderConfig,
